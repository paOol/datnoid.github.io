          ...
          <div className="max-w-3xl mx-auto text-center">
            <div>
              <div className="inline-flex font-medium bg-clip-text text-transparent bg-gradient-to-r from-purple-500 to-purple-200 pb-3">
                The secure and fair platform
              </div>
            </div>
            <h2 className="h2 bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-4">
              Audited by{' '}
              <a
                href="https://paladinsec.co/projects/datnoid/"
                rel="nofollow"
                target="_blank"
              >
                {' '}
            ...
            <p className="text-lg text-slate-400 mb-8">
              Trade safely, knowing we have been audited by the best and our
              contracts are free of exploits.
            </p>
            <div>
              <a
