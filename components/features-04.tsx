        ...
        <div className="pt-16 pb-12 md:pt-32 md:pb-20">
          ...
          <div className="max-w-3xl pb-12 md:pb-20">
            ...
            <p className="text-lg text-slate-400">
              Whether you're a trader or a liquidity provider, or an arbitrager,
              you'll find our platform to be the best choice for your needs.
            </p>
          </div>
              ...
              <div className="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400">
                    You no longer have to worry about having 50/50 ratios of
                    your assets in order to provide liquidity. Stake any asset
                    and earn our LP token.
                  </p>
                </div>
                {/* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">No Price Bins</h4>
                  </div>
                  <p className="text-sm text-slate-400">
                    Guessing the right price bin incorrectly could be costly. On
                    Datnoid, it's passive and always the maximum returns.
                  </p>
                </div>
                {/* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">High APRs</h4>
                  </div>
                  <p className="text-sm text-slate-400">
                    We offer exponentially higher APRs than any traditional DEX
                    because you earn for every swap of every asset on our
                    platform.
                  </p>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
                ...
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">Fair Launch</h4>
                  </div>
                  <p className="text-sm text-slate-400">
                    Never get Front run again with our Fair Launch Anti-botting
                    system.
                  </p>
                </div>
                {/* Feature */}
                <div>
                  ...
                  <p className="text-sm text-slate-400">
                    Our unified liquidity pool enables infinite routing. Perform
                    less swaps for the assets you want.
                  </p>
                </div>
                {/* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">Tooling</h4>
                  </div>
                  <p className="text-sm text-slate-400">
                    We integrate powerful tooling like wallet monitoring onto
                    our platform to make it easier to trade like a pro.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="py-8">
              ...
              <div className="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400">
                    Any universal asset used to swap for a token created on
                    Datnoid generates arbitrage.
                  </p>
                </div>
                {/* Feature */}
                <div>
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <h4 className="font-medium text-slate-50">Simple</h4>
                  </div>
                  <p className="text-sm text-slate-400">
                    Performing a swap is simple and easy to code for.
                  </p>
                </div>
              </div>
            </div>
