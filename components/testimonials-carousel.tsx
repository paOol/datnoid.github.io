          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <div>
              <div className="inline-flex font-medium bg-clip-text text-transparent bg-gradient-to-r from-purple-500 to-purple-200 pb-3">
                The unified liquidity platform
              </div>
            </div>
            ...
            <p className="text-lg text-slate-400">
              500 tokens on pump = 500 trading pairs. 500 tokens on Datnoid =
              124,750 trading pairs. Curve finance and balancer are also multi
              asset AMMs. They support about 5~8 assets, Datnoid supports
              thousands.
            </p>
          </div>
                    ...
                    <div className="flex flex-col p-6 h-full">
                      ...
                      <div className="grow">
                        ...
                        <div className="text-slate-400 mb-3">
                          Swap any token for any token without the need for
                          routing.
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="relative h-full bg-slate-900 rounded-[inherit] z-20 overflow-hidden">
                    ...
                    <div className="flex flex-col p-6 h-full">
                      ...
                      <div className="grow">
                        ...
                        <div className="text-slate-400 mb-3">
                          Bots are unable to front run users who participate in
                          fair launch.
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="relative h-full bg-slate-900 rounded-[inherit] z-20 overflow-hidden">
                    ...
                    <div className="flex flex-col p-6 h-full">
                      ...
                      <div className="grow">
                        ...
                        <div className="text-slate-400 mb-3">
                          No wallet? Just sign in with google or other socials.
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="relative h-full bg-slate-900 rounded-[inherit] z-20 overflow-hidden">
                    ...
                    <div className="flex flex-col p-6 h-full">
                      ...
                      <div className="grow">
                        ...
                        <div className="text-slate-400 mb-3">
                          We've been audited by Paladin and our contracts are
                          heavily tested.
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="relative h-full bg-slate-900 rounded-[inherit] z-20 overflow-hidden">
                    ...
                    <div className="flex flex-col p-6 h-full">
                      ...
                      <div className="grow">
                        ...
                        <div className="text-slate-400 mb-3">
                          Monitor user activity and other insights on datnoid
                          traders.
                        </div>
                      </div>
                    </div>
