...
import TestimonialImg01 from '@/public/defisi.png';
import TestimonialImg02 from '@/public/hans.jpg';
import TestimonialImg03 from '@/public/mrpink.png';
  ...
  const items: Item[] = [
    {
      ...
      quote:
        'I think the concept and Datnoid are great and things like this are what is required on $AVAX, to really drive the chain forward and also to help bridge users over from chains like Solana that are where all of the degens and therefore volume are.',
      name: 'Defi_Si',
      role: 'Degen',
    },
    {
      ...
      quote:
        'Site rly looks awesome and idea is gud, think it rly could be a wonderful platform!.',
      name: 'HansHuber',
      role: 'User',
    },
    {
      img: TestimonialImg03,
      quote: 'This is a good project, well done.',
      name: 'misterrpink1',
      role: 'entrepreneur',
    },
  ];
