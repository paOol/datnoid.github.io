                    ...
                    <div className="flex flex-col">
                      ...
                      <div className="md:max-w-[480px] shrink-0 order-1 md:order-none p-6 pt-0 md:p-8">
                        <div>
                          ...
                          <p className="text-slate-400">
                            One pool holds all the assets. Resulting in
                            efficient swaps and routing.
                          </p>
                        </div>
                      </div>
                      {/* Image */}
                    ...
                    <div className="flex flex-col">
                      ...
                      <div className="md:max-w-[480px] shrink-0 order-1 md:order-none p-6 pt-0 md:p-8">
                        <div>
                          ...
                          <p className="text-slate-400">
                            Swap Token A for B, or A for C, or B for Z.{' '}
                          </p>
                        </div>
                      </div>
                      {/* Image */}
          ...
          <div className="grid md:grid-cols-3 gap-8 md:gap-12">
            ...
            <div>
              ...
              <p className="text-sm text-slate-400">
                Losing money for providing liquidity is old news.
              </p>
            </div>
            {/* Feature */}
            <div>
            ...
            <div>
              ...
              <p className="text-sm text-slate-400">
                Everyone has a fair chance of getting the first buy, thus the
                best price quote.
              </p>
            </div>
            {/* Feature */}
            <div>
              ...
              <p className="text-sm text-slate-400">
                Not a fan of fairness? We support the old ways of doing things
                as well.
              </p>
            </div>
            {/* Feature */}
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                <h4 className="font-medium text-slate-50">Instant Launch</h4>
              </div>
              <p className="text-sm text-slate-400">
                Skip the scheduling entirely and your token is available for
            ...
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                <h4 className="font-medium text-slate-50">Points</h4>
              </div>
              <p className="text-sm text-slate-400">
                Earn points based on your PnL trading activity; Earn rewards.
              </p>
            </div>
          </div>
        </div>
